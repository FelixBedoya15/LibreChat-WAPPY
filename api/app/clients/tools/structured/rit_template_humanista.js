...
<div class="rit-document">
  ...
  <p>Este documento tiene como finalidad fundamental regular y definir las condiciones que deben sujetar a la organización y a los colaboradores en el desempeño de las labores, promoviendo el respeto, la sana convivencia, la prevención del acoso laboral y sexual, y el desarrollo de un entorno de trabajo digno y justo, en consonancia con los principios de la Organización Internacional del Trabajo (OIT).</p>
  ...
  <p>En el evento en que la empresa opere a través de plataformas digitales de reparto o servicios similares, se dará estricto cumplimiento a las disposiciones de formalización laboral establecidas en la Ley 2466 de 2025. Se reconocerá el vínculo laboral de los colaboradores, su afiliación al Sistema de Seguridad Social Integral y los derechos de sindicalización y negociación colectiva.</p>
  ...
  <p>La jornada ordinaria de trabajo es la que convengan las partes, o a falta de convenio, la jornada máxima legal. Conforme a lo dispuesto en la Ley 2101 de 2021 y reforzado en la legislación laboral vigente (Ley 2466 de 2025), la jornada máxima de trabajo a partir de julio de 2026 será de cuarenta y dos (42) horas semanales. Esta jornada podrá ser distribuida en mutuo acuerdo, en 5 o 6 días a la semana garantizando el día de descanso. Aquellos colaboradores de dirección, confianza y manejo están excluidos de la jornada máxima legal de acuerdo con el Art. 162 del CST.</p>

  <h3>Art. 11° Horarios de entrada y salida / Turnos rotativos</h3>
  <p>la organización podrá establecer y modificar los horarios y turnos de trabajo según las necesidades operativas, respetando la jornada máxima, mediante un preaviso razonable a los colaboradores. Los horarios de entrada y salida, así como los descansos, se definirán de forma específica en cada dependencia. Cuando la naturaleza de la labor lo requiera, la empresa podrá implementar sistemas de turnos de trabajo sucesivos y rotativos.</p>
  ...
  <p>Todos los colaboradores están obligados a registrar personal e intransferiblemente su asistencia al iniciar y finalizar su jornada laboral mediante los mecanismos dispuestos por la empresa (biométricos, aplicaciones, planillas, etc.). El incumplimiento de esta obligación sin causa justificada o la alteración de los registros de asistencia constituirán falta restaurativa y comportamental.</p>
  ...
  <p>Se garantiza el legítimo derecho de los colaboradores a la desconexión laboral digital. Una vez finalizada la jornada ordinaria de trabajo y durante los períodos de descanso remunerado, licencias, vacaciones y festivos, el colaborador (bioindividuo) tiene el derecho a no tener contacto laboral, no responder comunicaciones o requerimientos relacionados con su empleo, y a que la empresa respete su tiempo de descanso y vida familiar o personal.</p>

  <h3>Art. 19° Protocolo de desconexión</h3>
  <p>la organización, los jefes inmediatos y supervisores deberán abstenerse de enviar correos electrónicos, mensajes de WhatsApp u otras aplicaciones de mensajería, o realizar llamadas fuera del horario laboral. Si por automatización de correos algún mensaje es recibido fuera de horario, el colaborador (bioindividuo) no estará en la obligación de leerlo ni responderlo hasta el inicio de su siguiente jornada hábil. No podrá haber ninguna repercusión negativa o medida formativa por no responder requerimientos fuera del horario.</p>
  ...
  <p>La empresa concederá el tiempo necesario y prudencial como permiso remunerado, a los colaboradores que deban asistir a citaciones obligatorias escolares, reuniones de padres de familia y acompañamiento frente a procesos pedagógicos ineludibles de sus hijos menores de edad. Estos permisos deben ser acordados y demostrados oportunamente con la dirección de la empresa según la reforma laboral (Ley 2466/2025).</p>
  ...
  <p>Son obligaciones irrenunciables dla organización:</p>
  <ol style="margin-left: 20px; margin-bottom: 15px; line-height: 1.6;">
  ...
  <p>el colaborador (bioindividuo) está legalmente obligado a:</p>
  <ol style="margin-left: 20px; margin-bottom: 15px; line-height: 1.6;">
  ...
  <p>Son obligaciones especiales dla organización (Art. 57 CST):</p>
  <ol style="margin-left: 20px; margin-bottom: 15px; line-height: 1.6;">
  ...
  <p>la organización tiene prohibido (Art. 59 CST):</p>
  <ol style="margin-left: 20px; margin-bottom: 15px; line-height: 1.6;">
  ...
  <p>Son deberes del colaborador (bioindividuo) (Art. 58 CST):</p>
  <ol style="margin-left: 20px; margin-bottom: 15px; line-height: 1.6;">
  ...
  <p>Está estrictamente prohibido a los colaboradores (Art. 60 CST y demás):</p>
  <ol style="margin-left: 20px; margin-bottom: 15px; line-height: 1.6;">
  ...
  <h3>Art. 60° Principios rectores y humanistas</h3>
  ...
  <table style="width: 100%; border-collapse: collapse; margin-top: 10px; margin-bottom: 20px;">
    ...
    <tbody>
      ...
      <tr><td style="padding: 10px; border: 1px solid #e0e0e0; text-align: center;">10</td><td style="padding: 10px; border: 1px solid #e0e0e0;">La desobediencia manifiesta al derecho a la desconexión laboral de sus integrante del equipos causando coacción y hostigamiento.</td></tr>
  ...
  <p>Estarán facultados directa y expresamente para citar a descargos, dirigir la audiencia y resolver la imposición de las medidas formativas restaurativa y comportamentals hasta por despido de justa causa, los siguientes cargos dentro de la estructura empresarial:</p>
  <p><strong>Cargos facultados:</strong><br>
  {{cargos_sancionatorios}}</p>
  <p>Toda medida formativa superior a amonestación verbal deberá constar en copia en el expediente laboral del colaborador (bioindividuo) reposado en Gestión Humana o la dependencia correspondiente.</p>

  <h3>Art. 67° Término de prescripción para la gestión</h3>
  <p>la organización perderá toda facultad y caducará la potestad restaurativa y comportamental para investigar y sancionar faltas de los colaboradores, si dentro de los tres (3) meses siguientes al conocimiento efectivo de la ocurrencia del hecho, no ha citado formalmente a descargos o impuesto la medida formativa correspondiente, tal como lo regula el Código Sustantivo del Trabajo.</p>

  <h2>CAPÍTULO X — PREVENCIÓN Y PROTOCOLO DE ACOSO LABORAL (Ley 1010/2006)CAPÍTULO X — PREVENCIÓN DEL ACOSO LABORAL (Ley 1010/2006)</h2>
  <h3>Art. 68° Política de cero tolerancia al acoso laboral</h3>
  <p>En concordancia con la Constitución Política, la Ley 1010 de 2006 y normativas vigentes del Ministerio del Trabajo, la empresa adopta una política de cero tolerancia frente a toda práctica de acoso laboral, discriminación y maltrato. Garantizamos a todos los colaboradores el derecho a un ambiente libre de violencia en el que se respete la salud mental, la dignidad y el derecho al trabajo en condiciones justas.</p>
  ...
  <h2>CAPÍTULO XI — PREVENCIÓN Y PROTOCOLO DE ACOSO SEXUAL (Ley 2365/2024)CAPÍTULO XI — PREVENCIÓN DEL ACOSO SEXUAL (Ley 2365/2024)</h2>
  <h3>Art. 79° Política de prevención y cero tolerancia al acoso sexual</h3>
  ...
  <p>Una vez agotado el trámite investigativo restaurativo y comportamental con plena garantía constitucional, en caso de dictamen contundente por materialidad probatoria e indicial en actos de Acoso Sexual Laboral, se aplicará invariablemente la medida formativa máxima correspondiente a Despido Unilateral y Directo por Justa Causa legal tipificado como Falta Grave, sin desmedro del traslado del caso a las autoridades de justicia penal ordinaria (Fiscalía General de la Nación).</p>
  ...
  <p>Es política expresa y constitucional la no discriminación del ingreso a personas por motivo de su discapacidad física o mental dictaminada, debiendo la organización garantizar los ajustes razonables requeridos para desarrollar la actividad del empleado. Queda proscrito el despido motivado exclusivamente por una discapacidad, ya que el mismo generaría como corolario legal la ineficacia del despido, el reintegro, y el resarcimiento indemnizatorio punitivo de 180 días de salario mínimo exigido por la Ley 361 de 1997 y 1618 de 2013.</p>
