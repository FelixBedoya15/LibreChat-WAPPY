...
class CanvasTool extends Tool {
  constructor(fields = {}) {
    ...
    this.name = 'canvas';
    this.description =
      'Herramienta interactiva de pantalla dividida (Canvas). Úsala para crear o editar: documentos de texto enriquecidos ("text") - OBLIGATORIO para políticas, reglamentos, manuales, contratos, cartas, planes, actas, informes y cualquier documento tradicional -, hojas de cálculo ("excel"), presentaciones ("presentation") y prototipos visuales/aplicaciones interactivas ("html") - SOLO para aplicaciones, páginas o juegos interactivos. El usuario ve los cambios reflejados en tiempo real en la barra lateral derecha. (NOTA: Para la Matriz de Peligros IPEVAR / GTC-45, NO uses canvas; usa exclusivamente matriz_ipevar).';
    this.req = fields.req;
      ...
      fileType: z
        ...
        .describe(
          'Tipo de archivo/lienzo del Canvas a crear o gestionar. Respeta estrictamente lo que pida el usuario mapeándolo según este diccionario de variables:\n' +
            ...
            '- "excel" (Hoja de cálculo): Úsalo si el usuario menciona: excel, hoja de cálculo, hoja de calculo, tabla de datos, grilla, indicadores, accidentalidad, fórmulas, celdas, cálculo, presupuesto, listado, registro, base de datos, gráfico, cronograma, plan de trabajo, seguimiento o inventario. (Para la Matriz de Peligros IPEVAR / GTC-45, está prohibido usar canvas, usa siempre la herramienta especializada matriz_ipevar).\n' +
