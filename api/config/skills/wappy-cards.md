---
name: wappy-cards
description: Instrucciones y estructura JSON para generar tarjetas interactivas de vidrio (glassmorphism) wappy-card para planes de acción, listas de verificación o resúmenes de riesgos.
triggers:
  - tarjeta
  - wappy-card
  - checklist
