            ...
            <div className="mx-auto max-w-4xl px-6 py-12">
                ...
                <div className="mb-12 text-center">
                    ...
                    <p className="mt-1 text-xs text-text-tertiary">
                        Al acceder o utilizar <strong>wappy.club</strong>, usted acepta estos términos.
                    </p>
                </div>
                ...
                <div className="mt-12 rounded-2xl border border-green-500/20 bg-gradient-to-br from-green-500/5 to-cyan-500/5 p-8 text-center">
                    ...
                    <div className="mt-4 flex flex-wrap items-center justify-center gap-6 text-sm text-text-secondary">
                        <a href="mailto:info@wappy.club" className="flex items-center gap-2 rounded-lg bg-surface-primary px-4 py-2 transition-all hover:bg-surface-hover hover:text-green-500">
                        ...
                        <a href="tel:+573102913651" className="flex items-center gap-2 rounded-lg bg-surface-primary px-4 py-2 transition-all hover:bg-surface-hover hover:text-green-500">
