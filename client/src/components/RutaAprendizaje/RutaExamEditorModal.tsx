...
export default function RutaExamEditorModal({ isOpen, onClose, onSave, initialExam, title = 'Editar Examen', contextTopic }: ExamEditorModalProps) {
    ...
    const [examAIModel, setExamAIModel] = useState('gemini-2.5-flash');
    ...
    const handleGenerateExam = async () => {
        ...
        try {
            ...
            const response = await axios.post('/api/ruta-aprendizaje/admin/generate', {
                type: 'exam',
