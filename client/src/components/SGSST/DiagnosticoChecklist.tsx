...
const DiagnosticoChecklist: React.FC<DiagnosticoChecklistProps> = ({ onAnalysisComplete }) => {
    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center gap-4 p-3 rounded-2xl bg-surface-secondary border border-border-medium shadow-lg w-fit mx-auto mb-6">
                {/* Historial */}
                <button 
                ...
                <button 
                    ...
                    title="Guardar Evaluación Localmente"
                ...
                <button 
                    ...
                    title="Guardar Informe en Servidor"
                ...
                {(editorContent) ? (
                    <div title="Exportar Documento">
                        <ExportDropdown content={editorContent || ''} fileName="Diagnostico_SST" />
                    </div>
                ) : (
