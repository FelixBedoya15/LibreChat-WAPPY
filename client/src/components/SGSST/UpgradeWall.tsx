    ...
    return (
        <div className="relative flex flex-col items-center justify-center p-12 text-center overflow-hidden bg-surface-primary dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl shadow-xl w-full max-w-4xl mx-auto my-10 group">
            ...
            <button
                ...
                className="relative inline-flex items-center justify-center px-10 py-4 font-bold text-white transition-all duration-300 ease-in-out z-10 overflow-hidden rounded-full hover:scale-105 hover:shadow-[0_0_20px_rgba(79,70,229,0.4)] group"
            >
                {/* Button Background */}
