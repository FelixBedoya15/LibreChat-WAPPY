                    ...
                    <div
                        ...
                        <div className="flex items-center gap-4 px-6 py-5 border-b border-border-light dark:border-border-medium/30 relative">
                            ...
                            <div className="text-left flex-grow">
                                ...
                                <p className="text-xs text-text-secondary font-semibold">Reporte de Actos y Condiciones</p>
                            </div>
                            <button
                                onClick={() => setShowQrModal(false)}
                        ...
                        <div className="p-6 flex flex-col bg-surface-primary dark:bg-zinc-900/10 space-y-5">
                            ...
                            <div className="bg-indigo-50/50 dark:bg-indigo-950/10 border border-indigo-100 dark:border-indigo-900/30 rounded-2xl p-4 text-left w-full flex items-start gap-3">
                                ...
                                <div className="space-y-0.5">
                                    <h4 className="text-xs font-bold text-indigo-800 dark:text-indigo-300">Reporte de Actos y Condiciones</h4>
                            ...
                            <div className="relative group flex flex-col items-center gap-3 py-2">
                                <div id="reportar-portal-qr-container" className="p-4 border border-border-medium bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.15)]">
                                    <QRCodeSVG value={`${window.location.origin}/sgsst-public/reportar/${user?.id || user?._id || ''}`} size={138} className="mx-auto" level="H" includeMargin={false} />
                                </div>
                                <button
