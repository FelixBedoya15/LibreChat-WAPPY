    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-1.5 overflow-x-auto whitespace-nowrap scrollbar-hide py-1 w-full border border-border-medium p-2 rounded-xl bg-surface-secondary shadow-sm">
                ...
                {/* Guardar Datos */}
                <button onClick={() => handleSave()} title="Guardar Datos" className="flex items-center justify-center w-10 h-10 bg-surface-primary border border-border-medium hover:bg-surface-hover text-text-primary rounded-full transition-all duration-300 shadow-sm shrink-0 disabled:opacity-50">
                ...
                {(editorContent || generatedReport) ? (
                    <ExportDropdown content={editorContent || ''} fileName={"Reglamento_Higiene_Seguridad_Industrial"} hideText />
                ) : (
