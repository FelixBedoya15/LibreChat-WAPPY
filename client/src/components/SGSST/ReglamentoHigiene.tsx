    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2 p-2 rounded-xl bg-surface-secondary border border-border-medium shadow-sm">
                ...
                {/* Guardar Datos */}
                <button onClick={() => handleSave()} className="group flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 border border-indigo-600 text-white rounded-full transition-all duration-300 shadow-sm shrink-0 disabled:opacity-50 cursor-pointer">
                ...
                {/* Exportar */}
                {(editorContent) ? (
                    <ExportDropdown content={editorContent || ''} fileName={"Reglamento_Higiene_Seguridad_Industrial"} />
                ) : (
