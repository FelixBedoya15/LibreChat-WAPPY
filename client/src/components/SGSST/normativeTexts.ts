...
export const NORMATIVE_FRAGMENTS = {
   ...
   'DEC_1072_ART_18_OBJETIVOS': `ARTÍCULO 2.2.4.6.18. Objetivos del Sistema de Gestión de la Seguridad y Salud en el Trabajo SG-SST.
    Los objetivos deben expresarse de conformidad con la política de seguridad y salud en el trabajo establecida en la empresa.
    
    Características:
    1. Ser claros, medibles, cuantificables y tener metas definidas.
    2. Ser adecuados al tamaño y actividad de la empresa.
    3. Ser coherentes con el de plan de trabajo anual.
    4. Ser compatibles con la normatividad vigente.
