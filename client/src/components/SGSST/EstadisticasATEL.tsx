    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex flex-col items-start justify-center gap-4 p-4 rounded-xl bg-surface-secondary border border-border-medium shadow-sm">
                ...
                <div className="flex flex-wrap items-center justify-center gap-2 p-3 rounded-2xl bg-surface-secondary border border-border-medium shadow-lg w-fit mx-auto mt-4 mb-2">
                    
                    {/* Grupo 1: Historial */}
                    <div className="flex items-center gap-2 px-1">
                        <button 
                            onClick={() => setIsHistoryOpen(!isHistoryOpen)} 
                            title="Historial de Indicadores ATEL"
