...
export default function EventsMeetButton({
    toggleNav,
    isSmallScreen,
    isCollapsed,
}: {
    ...
    const isActive = location.pathname.startsWith('/events-meet');
    ...
    return (
        ...
        >
            ...
            <span className="font-semibold text-text-primary text-[13px]">Eventos Meet</span>
        </motion.button>
    );
}
