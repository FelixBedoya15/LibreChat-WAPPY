      ...
      {({ open }) => (
        <>
          ...
          >
            ...
            {!isCollapsed && <span className="text-sm font-bold leading-tight uppercase tracking-wider">{label}</span>}
            {isCollapsed && (
                <div className="hidden sm:flex absolute left-full ml-4 items-center max-w-0 overflow-hidden opacity-0 group-hover:max-w-[150px] group-hover:opacity-100 transition-all duration-300 ease-in-out whitespace-nowrap bg-amber-600 text-white px-3 py-2 rounded-xl shadow-2xl pointer-events-none z-[110]">
