...
const RutaAprendizajeButton = ({
  ...
  const isActive = location.pathname.startsWith('/ruta-aprendizaje');
  ...
  return (
    ...
    >
      ...
      <span className="font-semibold text-text-primary text-[13px]">Ruta de aprendizaje</span>
    </motion.button>
  );
};

export default RutaAprendizajeButton;
