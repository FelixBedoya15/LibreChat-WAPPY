...
function Account() {
  ...
  return (
    <div className="flex flex-col gap-6 p-2 text-sm text-text-primary">
      ...
      {/* MIDDLE: Editar Perfil + Danger Zone side by side on md+ */}
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        {/* Editar Perfil Form */}
        <div className="md:col-span-8 flex flex-col gap-6 p-5 rounded-2xl border border-border-light bg-surface-primary shadow-sm h-fit">
          <div>
        ...
        {/* Danger Zone */}
        <div className="md:col-span-4 flex flex-col gap-2 p-5 rounded-2xl border border-red-500/20 bg-red-500/5 shadow-sm h-fit">
