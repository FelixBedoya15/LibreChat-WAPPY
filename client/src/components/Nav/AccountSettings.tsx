          ...
          >
           ...
           <div className="flex flex-col min-w-0 flex-1 overflow-hidden">
               ...
               <span className="text-[10px] text-text-tertiary uppercase font-bold tracking-widest group-hover:text-teal-600 transition-colors opacity-70">
                   {{ 'USER': 'Invitado', 'USER_GO': 'Go', 'USER_PLUS': 'Plus', 'USER_PRO': 'Pro', 'USER_IPEVAR': 'Wappy Vital', 'IPEVAR': 'Wappy Vital Legacy', 'USER_CUSTOM': 'A la Medida', 'ADMIN': 'Administrador' }[user?.role || ''] || 'Usuario'} 
               </span>
           </div>
