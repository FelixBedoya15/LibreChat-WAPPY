# Copy de Ventas — Curso "De la Idea a tu Propia App"
...
- ✅ Yo empecé con conocimientos básicos de programación. Tú vas a hacer el mismo recorrido, pero con IA haciendo el trabajo pesado que a mí me tomó años entender solo.

### El problema que resuelve el curso
Tienes una idea de negocio o ya tienes un negocio funcionando, pero:
- Contratar un desarrollador te cuesta entre $3.000.000 y $15.000.000 por un MVP simple
- No sabes por dónde empezar: dominio, servidor, base de datos, todo suena a chino
- Las plataformas "sin código" te limitan cuando quieres algo realmente tuyo, con tu propio servidor y sin depender de nadie

### Lo que te llevas
Al final del curso tienes, en tus manos, no en una diapositiva:
- Tu propia app funcionando, en producción
- Tu dominio propio
- Tu servidor propio, que tú controlas
- Una función de IA integrada (como la que uso yo en WAPPY para automatizar soporte)
- El conocimiento para seguir construyendo solo, sin depender de un desarrollador
...
> **Un MVP hecho por un freelancer te cuesta entre $3.000.000 y $8.000.000 y tarda entre 4 y 8 semanas — sin que tú aprendas nada del proceso.**
...
## VERSIÓN 3 — Mensaje corto para WhatsApp / Instagram / Reels

> Yo empecé sabiendo lo básico de programación.
> Hoy WAPPY, mi plataforma de SST, factura en promedio $17M al mes con más de 200 suscriptores — y el soporte lo automaticé con IA.
>
> Te voy a enseñar exactamente ese camino, pero más rápido, porque ahora existe Antigravity y la IA hace el trabajo pesado.
>
